    ...
    internal sealed class Configuration : DbMigrationsConfiguration<GymManagement.Data.ApplicationDbContext>
    {
        ...
        protected override void Seed(GymManagement.Data.ApplicationDbContext context)
        {
            ...
            var users = new User[]
            {
                ...
                new User{ Id = ids[3],Email = "bogdanvorobet@gmail.com", UserName = "bogdanvorobet@gmail.com", PasswordHash =  new PasswordHasher().HashPassword("Test1."),FirstName = "Bogdan", LastName = "Vorobet", PhoneNumber = "0756321456", SubscriptionId = 1},
